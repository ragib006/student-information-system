...
class BBA_student_edit_update_controller extends Controller
{


  public function updatebbastudent(Request $request,$bba_student_edit){
        ...
        DB::table('student_tb1')
            ->where('student_id',$bba_student_edit)
            ->update($data);
