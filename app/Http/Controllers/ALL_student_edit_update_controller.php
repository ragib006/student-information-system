...
class ALL_student_edit_update_controller extends Controller
{

public function updateallstudent(Request $request,$all_student_edit){
      ...
      DB::table('student_tb1')
          ->where('student_id',$all_student_edit)
          ->update($data);
