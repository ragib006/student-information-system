...
class ME_student_edit_update_controller extends Controller
{


  public function updatemestudent(Request $request,$me_student_edit){
        ...
        DB::table('student_tb1')
            ->where('student_id',$me_student_edit)
            ->update($data);
