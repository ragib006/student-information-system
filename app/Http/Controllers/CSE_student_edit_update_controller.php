...
class CSE_student_edit_update_controller extends Controller
{

public function updatecsestudent(Request $request,$cse_student_edit){
      ...
      DB::table('student_tb1')
          ->where('student_id',$cse_student_edit)
          ->update($data);
