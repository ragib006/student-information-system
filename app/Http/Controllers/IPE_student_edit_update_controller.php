...
class IPE_student_edit_update_controller extends Controller
{


  public function updateipestudent(Request $request,$ipe_student_edit){
        ...
        DB::table('student_tb1')
            ->where('student_id',$ipe_student_edit)
            ->update($data);
