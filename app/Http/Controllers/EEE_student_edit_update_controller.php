...
class EEE_student_edit_update_controller extends Controller
{


  public function updateeeestudent(Request $request,$eee_student_edit){
        ...
        DB::table('student_tb1')
            ->where('student_id',$eee_student_edit)
            ->update($data);
