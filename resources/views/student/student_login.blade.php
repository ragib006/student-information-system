              ...
              <form method="post" action="{{url('/studentlogin')}}" >
               {{ csrf_field() }}
                 ...
                 <div class="form-group">
                   ...
                   <input type="text" class="form-control p_input" name="student_email" placeholder="Please Enter Your Email">
                 </div>
                 <div class="form-group">
                   <label>Student Password </label>
                   <input type="password" class="form-control p_input"  name="student_password" placeholder="Please Enter Your password">
                 </div>
