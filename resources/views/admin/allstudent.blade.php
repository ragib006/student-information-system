...
@section('content')
     ...
     <div class="card">
           <div class="card-body">
             ...
             <div class="row">
               <div class="col-12">
                 <table id="order-listing" class="table table-striped" style="width:1500px">
                   <thead>
                   ...
                   <tbody style="text-align:center;">
                     ...
                     <tr>
                         ...
                         <td><img src="{{URL::to($v_student->student_image)}}" height="60" width="70" style="border-radius:50%;"></td>
                         ...
                         <td style="width:300px;">
                          ...
                          <a href="{{URL::to('/all_student_view/'.$v_student->student_id)}}"> <button class="btn btn-outline-primary" >view</button></a>
                          <a href="{{URL::to('/all_student_edit/'.$v_student->student_id)}}"><button class="btn btn-outline-primary">Edit</button>
                          <a href="{{URL::to('all_student_delate/'.$v_student->student_id)}}" id="delate"> <button class="btn btn-outline-primary">Delate</button></a>
                         </td>
                     </tr>
