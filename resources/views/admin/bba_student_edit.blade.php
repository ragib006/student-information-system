              ...
              <div class="col-12 col-lg-6 grid-margin">
                  <div class="card">
                      <div class="card-body">
                          ...
                          <form class="forms-sample" method="post" action="{{URL::to('/update_bba_student',$description_profile->student_id)}}" enctype="multipart/form-data">
              ...
              <div class="col-12 col-lg-6 grid-margin">
                  <div class="card">
                      <div class="card-body">
                          ...
                          <form class="forms-sample" method="post" action="{{URL::to('/update_eee_student',$description_profile->student_id)}}" enctype="multipart/form-data">
