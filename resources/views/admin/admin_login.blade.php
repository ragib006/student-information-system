              ...
              <form method="post" action="{{url('/adminlogin')}}" >
               {{ csrf_field() }}
                 ...
                 <div class="form-group">
                   <label>Email</label>
                   <input type="text" class="form-control p_input" name="admin_email" placeholder="Please Enter Your Email">
                 </div>
                 <div class="form-group">
                   <label>Password </label>
                   <input type="password" class="form-control p_input"  name="admin_password" placeholder="Please Enter Your password">
                 </div>
